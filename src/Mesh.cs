...
namespace TriangleNet
{
    ...
    public class Mesh : IMesh
    {
        ...
        public bool checksegments; // Are there segments in the triangulation yet?
        public bool checkquality;  // Has quality triangulation begun yet?

        // Triangular bounding box vertices.
        public Vertex infvertex1, infvertex2, infvertex3;
        ...
        public NodeNumbering numbering;
        ...
        public void TransferNodes(IList<Vertex> points)
        {
        ...
        public void MakeTriangle(ref Otri newotri)
        {
        ...
        public void MakeSegment(ref Osub newsubseg)
        {
        ...
        public void InsertSubseg(ref Otri tri, int subsegmark)
        {
        ...
        /// </remarks>
        public void Flip(ref Otri flipedge)
        {
            Otri botleft = default(Otri), botright = default(Otri);
            Otri topleft = default(Otri), topright = default(Otri);
            Otri top = default(Otri);
        ...
        /// </remarks>
        public void Unflip(ref Otri flipedge)
        {
            Otri botleft = default(Otri), botright = default(Otri);
            Otri topleft = default(Otri), topright = default(Otri);
            Otri top = default(Otri);
        ...
        /// may be deleted.
        /// </remarks>
        public void DeleteVertex(ref Otri deltri)
        {
        ...
        public void VertexDealloc(Vertex dyingvertex)
        {
